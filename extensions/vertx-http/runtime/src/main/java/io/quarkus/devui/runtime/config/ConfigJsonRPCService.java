...
public class ConfigJsonRPCService {
    ...
    public record ApplicationConfigDescription(
    ...
    private static ApplicationConfigDescription createApplicationConfigDescription(
        ...
        for (String profile : profiles) {
            ...
            if (null != rawValue) {
                return new ApplicationConfigDescription(
                        config,
                        rawValue,
                        profile);
            }
